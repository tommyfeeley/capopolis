...
class CapPenaltyAdmin(admin.ModelAdmin):
    list_display = ['team', 'season', 'amount', 'penalty_type']
    list_filter = ['season', 'team', 'penalty_type']
    search_fields = ['team__name', 'team__city']
    ordering = ['season', 'team__name', 'penalty_type']
